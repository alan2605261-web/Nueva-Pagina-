...
/* Poliza oficial "MF ONE Garantia" (31 ago 2026). Fuente unica de verdad:
   no agregar coberturas que no esten ahi.

   Contenido movido desde /garantia en sep 2026, cuando Saul pidio dejar de
   apilar las tres polizas en una sola pagina: /garantia pasa a ser el selector
...
export default function GarantiaMFOnePage() {
  return (
    <PageShell>
      <SubHero eyebrow="Garantía · MF ONE" title="Doce meses, desde que la recibes" tone="warm" />
      ...
      <CTASection
        ...
        body="MF Shield extiende la cobertura hasta dos años. Se contrata mientras la garantía estándar siga vigente."
