        ...
        <div className="mwrap">
          <Reveal>
            <article className="mx-auto max-w-[68ch]">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Datos que recopilamos</h2>
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Uso de los datos</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-4">
                Utilizamos tus datos personales para las siguientes finalidades primarias:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-2 text-[16px] leading-relaxed text-[var(--fg-muted)]">
              ...
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-4">Finalidades secundarias (puedes oponerte a ellas):</p>
              <ul className="list-disc pl-6 mb-8 space-y-2 text-[16px] leading-relaxed text-[var(--fg-muted)]">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Cookies y tecnologías de seguimiento</h2>
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Tus derechos ARCO</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-4">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Transferencia de datos</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-6">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Cambios a este aviso</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-6">
