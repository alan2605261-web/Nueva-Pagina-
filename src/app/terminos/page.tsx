        ...
        <div className="mwrap">
          <Reveal>
            <article className="mx-auto max-w-[68ch]">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Uso del sitio</h2>
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Compras y precios</h2>
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Envíos</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-6">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Propiedad intelectual</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-6">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Limitación de responsabilidad</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-6">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Legislación aplicable</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-6">
              ...
              <h2 className="mdisplay text-[clamp(20px,2.2vw,26px)] mb-4">Modificaciones</h2>
              <p className="text-[16px] leading-relaxed text-[var(--fg-muted)] mb-6">
